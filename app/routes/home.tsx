  ...
  return (
    <main className="container mx-auto p-6">
      ...
      <p className="mb-4">
        ...
        architecture's honesty and material-forward approach to digital design.
        It emphasizes function, exposed structure, and tactile materials while
        embracing strong contrasts and bold typographic choices.
      </p>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc ml-6 mt-2">
          ...
          <li>
            Material suggestion (concrete/metal textures) and imperfect details
          </li>
      ...
      <section className="mb-6">
        ...
        <p>
          Visitors notice a raw, tactile UI with clear modules and strong visual
          hierarchy. Despite the rough aesthetic, usability must be preserved:
          controls should be discoverable, text readable, and interactive
          elements accessible.
        </p>
      </section>
      ...
      <section className="mt-8">
        ...
        <ul className="list-disc ml-6 mt-2">
          <li>
            Always verify contrast for legibility — high-contrast is core to the
            look but still must meet WCAG for body and UI text.
          </li>
          <li>
            Keep interactive controls discoverable — use clear affordances even
            when chrome is minimal.
          </li>
          <li>
